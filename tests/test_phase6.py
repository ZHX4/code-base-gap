...
def _fixture() -> tuple[dict, dict]:
    phase2 = {
        ...
        "reconnaissance": {
            ...
            "deployment": [],
            "source_roots": ["src"],
            "likely_entry_points": ["src/api.py"],
    ...
    graph = {
        "schema_version": "phase4.program-knowledge-graph.v1",
        "repository_revision": REV,
        "limitations": [],
        "nodes": [
...
class Phase6Tests(unittest.TestCase):
    ...
    def test_input_loader_rejects_orphan_edge(self) -> None:
        phase2, graph = _fixture()
    ...
    def test_validation_rejects_unknown_references(self) -> None:
        model = SystemModel()
        model.normalize()
